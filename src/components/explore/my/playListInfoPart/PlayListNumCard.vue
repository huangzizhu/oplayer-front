    ...
    <div class="canvas">
      ...
      <div id="card">
        <div class="card-content">
          ...
          <p id="prompt1">歌曲总数</p>
          <br>
          <p id="prompt2">{{total}}&nbsp;&nbsp;首</p>
          <div class="title">总时长<br />{{duration[0]}}&nbsp;分<br />{{duration[1]}}&nbsp;秒</div>
          ...
          <div class="subtitle">
            ...
            <br>
            <span class="highlight">{{ updateTime[1]}}月</span>
            &nbsp;
            <span class="highlight">{{ updateTime[2]}}日</span>
          </div>
